...
class XPipeline():
    ...
    def __init__(self, input_file: str, output_dir: str = "./output", max_workers: int = 1, limit: int = 0):
        ...
        # Print log
        xlogger.info("XPipeline is initializing: input_file=`{}`, output_dir=`{}`, max_workers=`{}`, limit=`{}`".format(self.input_file, self.output_dir, self.max_workers, self.limit))
    ...
    def forward(self):
        ...
        # Start pipeline
        xlogger.info("===> Starting running XPipeline...")
        xlogger.info("======================================================")
